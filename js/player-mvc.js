		...
		this.model.setSongs([
			{
				name: 'El perdon',
				artist: 'Nicky Jam',
				src: 'media/Nicky Jam - El Perdon (Prod. Saga WhiteBlack).mp3',
				img: 'img/songs/el_perdon_big.jpg'
			},
			{
				name: 'Piensas en Mi',
				artist: 'Nicky Jam',
				src: 'media/Nicky Jam - Piensas En Mi ( Oficial Video @NickyjamPR ).mp3',
				img: 'img/songs/piensasenmi.jpg'
			},
			{
				name: 'Travesuras',
				artist: 'Nicky Jam',
				src: 'media/Travesuras Remix - Nicky Jam Ft De La Ghetto, J balvin, zion y Arcangel - Video Lyric.mp3',
				img: 'img/songs/travesuras.jpg'
			}
		])
